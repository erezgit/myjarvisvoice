  ...
  return (
    <>
      ...
      <FilterContext.Provider value={filters}>
        <div className="sticky top-0 z-10 -mx-6 px-6 pb-2 bg-[#f1f1f1] dark:bg-background border-b border-border/50">
        ...
        {pagination && (
          <div className="sticky bottom-0 z-10 -mx-6 px-6 py-2 bg-[#f1f1f1] dark:bg-background border-t border-border/50">
            {pagination}
          </div>
        )}
