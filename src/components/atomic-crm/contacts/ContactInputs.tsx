...
const ContactIdentityInputs = () => {
  const { contactGender, lifecycleStages, leadSources } = useConfigurationContext();
  return (
...
const ContactPositionInputs = () => {
  const { lifecycleStages, leadSources } = useConfigurationContext();
  return (
    <div className="flex flex-col gap-4">
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <SelectInput
          ...
          optionText={memberOptionRenderer}
          validate={required()}
        />
      </ReferenceInput>
    </div>
...
const memberOptionRenderer = (choice: Member) =>
