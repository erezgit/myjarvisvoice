 ...
 * Note: Voice URL transformation requires user context - this is typically handled
 * by the streaming message processor which has access to the API base URL.
 */
export function createVoiceMessageFromInput(
  ...
  // Extract filename from path for web API endpoint
  const filename = audioPath.split('/').pop() || '';

  // Note: The actual URL transformation happens in the streaming processor
  // which has access to the API base URL. This is a placeholder that will
  // be transformed by the caller.
